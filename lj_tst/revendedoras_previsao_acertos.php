...
array_push($breadcrumbs, array('revendedoras.php','Revendedoras (fornecimento)'));
...
while($line = db_read($rlt))
	{
	$cor = '';
	if ($line['kh_previsao'] < date("Ymd")) { $cor = '<font color="red">'; $atra++; }
	$tot1=$tot1+1;
	...
	$sa .= '<TD align="left">';
	$sa .= $cor;
	$sa .= trim($line['cl_nome']);

	$sa .= '<TD align="left">';
	$sa .= $cor;
	$sa .= trim($line['cl_clientep']);
