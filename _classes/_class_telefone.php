		...
		function cp()
			{
				...
				array_push($cp,array('$A8','','Cliente '.$dd[1],False,True,''));
				...
				array_push($cp,array('$Q p_nome:p_cod:select * from parentesco where p_ativo=1 order by p_nome','tel_parentesco','Parentesco',True,True,''));
