	...
	function cp()
		{
			...
			array_push($cp,array('$CEP','ce_cep','CEP',False,True));
			array_push($cp,array('$U8','ce_data','',True,True));
			array_push($cp,array('$HV','ce_hora',date("H:i"),True,True));
			array_push($cp,array('$HV','ce_log',$user_log,True,True));
			array_push($cp,array('$S40','ce_cidade','Cidade',True,True));
			array_push($cp,array('$S2','ce_estado','Estado',False,True));
			array_push($cp,array('$HV','ce_pais','BRA',False,True));
			array_push($cp,array('$S30','ce_bairro','Bairro',True,True));
			array_push($cp,array('$S100','ce_endereco','Endereço',True,True));
			array_push($cp,array('$O 1:SIM&0:NÃO','ce_ativo','Ativo',True,True));
			array_push($cp,array('$HV','ce_extinto','0',False,True));
			array_push($cp,array('$H8','ce_extinto_log','',False,True));
			array_push($cp,array('$H8','ce_cidade_cod','Cidade',True,True));
			return($cp);
		}
	function cp_cep()
		{
			...
			array_push($cp,array('$H8','id_ce','',False,True));
			array_push($cp,array('$H8','ce_cliente','',True,True));
			array_push($cp,array('$CEP','ce_cep','Informe o CEP',False,True));
